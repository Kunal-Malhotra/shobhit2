  ...
  return(
    ...
    <div className="container">
        <div className="row">
            ...
            <div className="col">
               <h4>ABOUT US</h4>
               <p>Infra Store is an online procurement platform of all types of building material for Contractors, Developers who is in real estate business. Infra Store is responsible for providing genuine products at affordable price</p>
            </div>
            <div className="col">
               <h4>CONTACT</h4>
               <ul className="list-unstyled">
                   <li>Contact Us</li>
                   <li>Talk with a Coach</li>
               </ul>
            </div>
            <div className="col">
                <ul className="list-unstyled">
